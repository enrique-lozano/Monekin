...
class _TranslationsTagsFormZhCn implements TranslationsTagsFormEn {
	...
	@override String get forbidden_char_error => '名称不能包含 \';\'';
	@override String get description => '描述';
}
...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'intro.skip' => '跳过',
			'intro.next' => '继续',
			'intro.select_your_currency' => '选择您的货币',
			'intro.welcome_subtitle' => '您的个人财务管家',
			'intro.welcome_subtitle2' => '100% 开放，100% 免费',
			'intro.welcome_footer' => '登录即表示您同意<a href=\'https://github.com/enrique-lozano/Monekin/blob/main/docs/PRIVACY_POLICY.md\'>隐私策略</a>和此应用的<a href= \'https: //github.com/enrique-lozano/Monekin/blob/main/docs/TERMS_OF_USE.md\'>使用条款</a>',
			'intro.offline_descr_title' => '本地账户：',
			'intro.offline_descr' => '您的数据只会存储于此设备中，只要您不卸载应用或更换手机，数据就会保持安全。为避免数据丢失，建议定期从应用设置中备份数据。',
			'intro.offline_start' => '开始使用本地账户',
			'intro.sl1_title' => '选择您的货币',
			'intro.sl1_descr' => '您的默认货币会被用于报表和图表中。您之后可以随时更改默认货币和应用语言',
			'intro.sl2_title' => '安全、隐私、可靠',
			'intro.sl2_descr' => '您的数据只属于您。我们直接将您的信息存储于此设备，不会连接外部服务器。因此您可以在离线时继续使用此应用',
			'intro.sl2_descr2' => '此外，此应用的源代码是公开的，任何人都可以查看它如何运行并贡献自己的力量',
			'intro.last_slide_title' => '全部就绪',
			'intro.last_slide_descr' => '使用 Monekin，您最终可以实现自己想要的财务独立。您将拥有和您的钱相关的图表、预算、提示、统计信息等。',
			'intro.last_slide_descr2' => '祝您使用愉快！如果您有任何疑问或建议，请随时与我们联系……',
			'home.title' => '面板',
			...
			'tags.form.forbidden_char_error' => '名称不能包含 \';\'',
