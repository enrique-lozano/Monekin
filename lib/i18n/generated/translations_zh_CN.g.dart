...
class _TranslationsCurrenciesZhCn implements TranslationsCurrenciesEn {
  ...
  @override
  late final _TranslationsCurrenciesFormZhCn form =
      _TranslationsCurrenciesFormZhCn._(_root);
  @override
...
class _TranslationsSettingsZhCn implements TranslationsSettingsEn {
  ...
  // Translations
  @override
  String get title_long => '设置和外观';
  @override
  String get title_short => '设置';
  @override
  String get description => '应用主题、语言和其它常规设置';
  @override
  String get edit_profile => '编辑个人资料';
  @override
  String get lang_section => '语言和文字';
  @override
  String get lang_title => '语言/Language';
  @override
  String get lang_descr => '应用中显示文字的语言';
  @override
  String get lang_help =>
      '如果您想合作翻译此应用，您可参考<a href=\'https://github.com/enrique-lozano/Monekin/tree/main/lib/i18n\'>我们的指南</a>';
  @override
  String get locale => '地区';
  @override
  String get locale_auto => '系统';
  @override
  String get locale_descr => '设置用于日期、数字的格式……';
  @override
  String get locale_warn => '更改区域时应用将更新';
  @override
  ...
  String get theme => '主题';
  @override
  String get theme_auto => '系统';
  @override
  String get theme_light => '明亮主题';
  @override
  String get theme_dark => '黑暗主题';
  @override
...
class _TranslationsBudgetsDetailsZhCn implements TranslationsBudgetsDetailsEn {
  ...
  }) => '在未来 ${remainingDays} 天中，您每天可以花费 ${dailyAmount}';
  @override
...
class _TranslationsMoreAboutUsZhCn implements TranslationsMoreAboutUsEn {
  ...
  @override
  String get description => '查看有关 Monekin 的条款和其它相关信息。与社区取得联系以报告错误、留下建议……';
  @override
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'general.clipboard.success':
        return ({required Object x}) => '已复制 ${x}';
      ...
      case 'general.validations.min_number':
        return ({required Object x}) => '应大于${x}';
      case 'general.validations.max_number':
        return ({required Object x}) => '应小于${x}';
      case 'intro.start':
        return '开始';
      case 'intro.skip':
        return '跳过';
      ...
      case 'intro.welcome_subtitle2':
        return '100% 开放，100% 免费';
      case 'intro.welcome_footer':
        return '登录即表示您同意<a href=\'https://github.com/enrique-lozano/Monekin/blob/main/docs/PRIVACY_POLICY.md\'>隐私策略</a>和此应用的<a href= \'https: //github.com/enrique-lozano/Monekin/blob/main/docs/TERMS_OF_USE.md\'>使用条款</a>';
      case 'intro.offline_descr_title':
        return '本地账户：';
      case 'intro.offline_descr':
        return '您的数据只会存储于此设备中，只要您不卸载应用或更换手机，数据就会保持安全。为避免数据丢失，建议定期从应用设置中备份数据。';
      case 'intro.offline_start':
        return '开始使用本地账户';
      case 'intro.sl1_title':
        return '选择您的货币';
      case 'intro.sl1_descr':
        return '您的默认货币会被用于报表和图表中。您之后可以随时更改默认货币和应用语言';
      case 'intro.sl2_title':
        return '安全、隐私、可靠';
      case 'intro.sl2_descr':
        return '您的数据只属于您。我们直接将您的信息存储于此设备，不会连接外部服务器。因此您可以在离线时继续使用此应用';
      case 'intro.sl2_descr2':
        return '此外，此应用的源代码是公开的，任何人都可以查看它如何运行并贡献自己的力量';
      case 'intro.last_slide_title':
        return '全部就绪';
      case 'intro.last_slide_descr':
        return '使用 Monekin，您最终可以实现自己想要的财务独立。您将拥有和您的钱相关的图表、预算、提示、统计信息等。';
      case 'intro.last_slide_descr2':
        return '祝您使用愉快！如果您有任何疑问或建议，请随时与我们联系……';
      case 'home.title':
        return '面板';
      ...
      case 'financial_health.savings_percentage.text.very_bad':
        return '哇，您在这段时间内并没有任何结余。';
      case 'financial_health.savings_percentage.suggestion':
        return '请记住，建议至少将您赚到的 15-20% 存下来。';
      case 'stats.title':
        return '统计数据';
      case 'stats.balance':
        return '余额';
      ...
      case 'transaction.delete_multiple_success':
        return ({required Object x}) => '${x}笔交易删除成功';
      ...
      case 'transaction.next_payments.skip_dialog_msg':
        return ({required Object date}) => '此操作无法撤回。我们将把下次的日期移动至${date}';
      ...
      case 'transaction.next_payments.accept_dialog_msg_single':
        return '此交易的新状态将为null。您可以随时重新编辑此交易的状态';
      ...
      case 'transaction.next_payments.recurrent_rule_finished':
        return '循环规则已完成，没有更多的支付！';
      case 'transaction.list.empty':
        return '未发现需要显示的交易。请先在应用中添加一些交易，下次再来查看';
      ...
      case 'transaction.form.description_info':
        return '点击此处输入有关此交易的详细描述';
      case 'transaction.form.exchange_to_preferred_title':
        return ({required Object currency}) => '汇率为${currency}';
      ...
      case 'transaction.reversed.description_for_expenses':
        return '尽管是一个开支交易，但其数额为正值。此类交易可用于表示已记录开支的返还，例如退款或偿还债务。';
      case 'transaction.reversed.description_for_incomes':
        return '尽管是一个收入交易，但其数额为负值。此类交易可用于作废或更正收入记录中的错误，以反映退款或记录偿还债务。';
      ...
      case 'account.close.warn':
        return '此账户将不再出现在特定列表中，并且您无法在此账户中创建晚于以下日期的交易。此操作不会影响任何交易或余额，您也可以随时重新开启此账户。';
      case 'account.close.should_have_zero_balance':
        return '此账户中的当前余额必须为 0 才可关闭。请在继续之前编辑账户';
      case 'account.close.should_have_no_transactions':
        return '此账户在指定的关闭日期之后仍有交易。请删除它们或编辑账户关闭日期，然后再继续';
      ...
      case 'currencies.change_preferred_currency_msg':
        return '从现在起，所有统计数据和预算都将以此货币显示。账户和交易将保留其原有货币单位。如果您执行此操作，所有保存的汇率都将被删除。您想继续吗？';
      ...
      case 'currencies.empty':
        return '如果您有账户使用默认货币以外的货币，请在此处添加汇率，以获得更准确的图表';
      ...
      case 'tags.empty_list':
        return '您还没有创建任何标签。标签和类别是对您的动作进行分类的好方法';
      ...
      case 'categories.merge_warning2':
        return ({required Object from}) => '类别<b>${from}</b>将被无法撤回地删除。 ';
      ...
      case 'categories.delete_warning_message':
        return ({required Object x}) => '此操作将无法撤回地删除与此类别相关的所有交易<b>(${x})</b>。';
      ...
      case 'budgets.no_budgets':
        return '未发现应当显示的预算。请点击底部的 \'+\' 按钮新增一个预算';
      case 'budgets.delete':
        return '删除预算';
      case 'budgets.delete_warning':
        return '此操作无法撤回。此预算中的类别和交易不会被删除';
      ...
      case 'backup.export.all_descr':
        return '导出您的所有数据（账户、交易、预算、设置……）。随时再次导入它们，您就不会丟失任何內容。';
      case 'backup.export.transactions':
        return '交易备份';
      case 'backup.export.transactions_descr':
        return '以 CSV 格式导出您的交易，以便您可以在其它程序或应用中更轻松地分析。';
      case 'backup.export.description':
        return '以不同格式下载（导出）数据';
      case 'backup.export.dialog_title':
        return '保存/发送文件';
      case 'backup.export.success':
        return ({required Object x}) => '文件已成功保存/下载至 ${x}';
      case 'backup.export.error':
        return '下载文件时发生错误。请通过 lozin.technologies@gmail.com 联系开发人员';
      ...
      case 'backup.import.restore_backup_descr':
        return '导入一个从 Monekin 保存的数据库。此操作将用新数据覆盖当前应用数据';
      case 'backup.import.restore_backup_warn_description':
        return '导入新数据库时，您将丟失应用中当前保存的所有数据。建议在继续之前进行备份。请勿在此上传任何来源不明的文件，仅上传您之前从 Monekin 下载的文件';
      ...
      case 'settings.lang_help':
        return '如果您想合作翻译此应用，您可参考<a href=\'https://github.com/enrique-lozano/Monekin/tree/main/lib/i18n\'>我们的指南</a>';
      ...
      case 'settings.amoled_mode_descr':
        return '尽可能使用纯黑色壁纸。在 AMOLED 屏幕的设备上能略微省电';
