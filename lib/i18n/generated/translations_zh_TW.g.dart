...
class _TranslationsCurrenciesZhTw implements TranslationsCurrenciesEn {
  ...
  @override
  late final _TranslationsCurrenciesFormZhTw form =
      _TranslationsCurrenciesFormZhTw._(_root);
  @override
...
class _TranslationsBudgetsZhTw implements TranslationsBudgetsEn {
  ...
  @override
  String get pending => '等待開始';
  @override
  String get finish => '完成的';
  @override
...
class _TranslationsSettingsZhTw implements TranslationsSettingsEn {
  ...
  // Translations
  @override
  String get title_long => '設定和外觀';
  @override
  String get title_short => '設定';
  @override
  String get description => '應用程式主題、文字和其他常規設定';
  @override
  String get edit_profile => '編輯個人資料';
  @override
  String get lang_section => '語言和文本';
  @override
  String get lang_title => '應用程式語言';
  @override
  String get lang_descr => '應用程式中顯示文字的語言';
  @override
  String get lang_help =>
      '如果您想與此應用程式的翻譯合作，您可以參考<a href=\'https://github.com/enrique-lozano/Monekin/tree/main/lib/i18n\'>我們的指南</a>';
  @override
  String get locale => '地區';
  @override
  String get locale_auto => '系統';
  @override
  String get locale_descr => '設定用於日期、數字的格式...';
  @override
  String get locale_warn => '更改區域時應用程式將更新';
  @override
  ...
  String get theme => '主題';
  @override
  String get theme_auto => '系統';
  @override
  String get theme_light => '明亮主題';
  @override
  String get theme_dark => '黑暗主題';
  @override
...
class _TranslationsBudgetsDetailsZhTw implements TranslationsBudgetsDetailsEn {
  ...
  }) => '您每天可以花費${dailyAmount}/天，持續${remainingDays}天';
  @override
...
class _TranslationsMoreAboutUsZhTw implements TranslationsMoreAboutUsEn {
  ...
  @override
  String get description => '查看有關 Monekin 的條款和其他相關資訊。透過報告錯誤、留下建議與社區取得聯繫......';
  @override
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'general.clipboard.success':
        return ({required Object x}) => '${x}已複製到剪貼簿';
      ...
      case 'general.time.ranges.types.last_days_form':
        return ({required Object x}) => '前${x}天';
      ...
      case 'intro.welcome_subtitle2':
        return '100% 開放，100% 免費';
      case 'intro.welcome_footer':
        return '登入即表示您同意<a href=\'https://github.com/enrique-lozano/Monekin/blob/main/docs/PRIVACY_POLICY.md\'>隱私權政策</a>和<a href= \'https: //github.com/enrique-lozano/Monekin/blob/main/docs/TERMS_OF_USE.md\'>應用程式的使用條款</a>';
      case 'intro.offline_descr_title':
        return '離線帳戶：';
      case 'intro.offline_descr':
        return '您的資料只會儲存在您的裝置上，只要您不卸載應用程式或更換手機，資料就安全。為防止資料遺失，建議定期從應用程式設定中進行備份。';
      case 'intro.offline_start':
        return '離線啟動會話';
      case 'intro.sl1_title':
        return '選擇您的貨幣';
      case 'intro.sl1_descr':
        return '您的預設貨幣將用於報告和一般圖表。您以後可以隨時在應用程式設定中更改貨幣和應用程式語言';
      case 'intro.sl2_title':
        return '安全、隱私、可靠';
      case 'intro.sl2_descr':
        return '您的資料只屬於您。我們將資訊直接儲存在您的設備上，無需通過外部伺服器。這使得即使沒有互聯網也可以使用該應用程式';
      case 'intro.sl2_descr2':
        return '此外，該應用程式的源代碼是公開的，任何人都可以對其進行協作並查看它是如何工作的';
      case 'intro.last_slide_title':
        return '一切準備就緒';
      case 'intro.last_slide_descr':
        return '有了 Monekin，您終於可以實現您想要的財務獨立。您將擁有圖表、預算、提示、統計數據以及更多有關您的資金的信息。';
      case 'intro.last_slide_descr2':
        return '我們希望您享受這次體驗！如有疑問、建議，請隨時與我們聯繫......';
      case 'home.title':
        return '儀表板';
      ...
      case 'financial_health.savings_percentage.text.very_bad':
        return '哇哦，這段時間你什麼都沒保存下來。';
      case 'financial_health.savings_percentage.suggestion':
        return '請記住，建議將收入的至少 15-20% 存起來。';
      case 'stats.title':
        return '統計數據';
      case 'stats.balance':
        return '平衡';
      ...
      case 'transaction.delete_multiple_success':
        return ({required Object x}) => '正確刪除了${x}筆交易';
      ...
      case 'transaction.next_payments.recurrent_rule_finished':
        return '循環規則已完成，無需再支付！';
      case 'transaction.list.empty':
        return '未發現此處顯示的交易。在應用程式中添加一些交易，也許您下次會有更好的運氣';
      ...
      case 'transaction.form.description_info':
        return '點擊此處輸入有關此交易的更詳細描述';
      case 'transaction.form.exchange_to_preferred_title':
        return ({required Object currency}) => '匯率為${currency}';
      ...
      case 'transaction.reversed.description_for_expenses':
        return '儘管是收入交易，但它的金額為正數。這些類型的交易可用於表示先前記錄的收入的返還，例如退款或償還債務。';
      case 'transaction.reversed.description_for_incomes':
        return '儘管是一項收入交易，但其金額為負數。這些類型的交易可用於作廢或更正錯誤記錄的收入，反映資金的返還或退款或記錄債務的支付。';
      ...
      case 'transaction.status.tr_status':
        return ({required Object status}) => '${status}交易';
      ...
      case 'account.form.currency_not_found_warn':
        return '您沒有該貨幣的匯率資訊。1.0 將用作預設匯率。您可以在設定中修改';
      case 'account.form.already_exists':
        return '已經有另一個同名，請再寫一個';
      case 'account.form.tr_before_opening_date':
        return '該帳戶中有日期早於開戶日期的交易';
      ...
      case 'account.close.warn':
        return '此帳戶將不再出現在某些清單中，您將無法在其中建立日期晚於下面指定的日期的交易。此操作不會影響任何交易或餘額，您也可以隨時重新開啟此帳戶時間。 ';
      case 'account.close.should_have_zero_balance':
        return '此帳戶中的當前餘額必須為 0 才能關閉它。請在繼續之前編輯帳戶';
      case 'account.close.should_have_no_transactions':
        return '此帳戶在指定的關閉日期之後有交易。請刪除它們或編輯帳戶關閉日期，然後再繼續';
      ...
      case 'currencies.change_preferred_currency_msg':
        return '從現在開始，所有統計數據和預算都將以該貨幣顯示。帳戶和交易將保留其所擁有的貨幣。如果您執行此操作，所有保存的匯率都將被刪除。您想繼續嗎？';
      ...
      case 'currencies.empty':
        return '在此處添加匯率，以便如果您的帳戶使用基礎貨幣以外的貨幣，我們的圖表會更加準確';
      ...
      case 'tags.empty_list':
        return '您還沒有建立任何標籤。標籤和類別是對您的動作進行分類的好方法';
      ...
      case 'categories.merge_warning2':
        return ({required Object from}) => '類別<b>${from}</b>將被不可逆轉地刪除。 ';
      ...
      case 'categories.delete_warning_message':
        return ({required Object x}) => '此操作將不可逆轉地刪除與此類別相關的所有交易<b>(${x})</b>。';
      ...
      case 'budgets.no_budgets':
        return '此部分中似乎沒有可顯示的預算。首先單擊下面的按鈕以建立預算';
      case 'budgets.delete':
        return '刪除預算';
      case 'budgets.delete_warning':
        return '此操作不可逆轉。引用此報價的類別和交易不會被刪除';
      ...
      case 'backup.export.all_descr':
        return '匯出您的所有資料（帳戶、交易、預算、設定...）。隨時重新匯入它們，這樣您就不會丟失任何內容。';
      case 'backup.export.transactions':
        return '交易備份';
      case 'backup.export.transactions_descr':
        return '以 CSV 格式匯出您的交易，以便您可以在其他程式或應用程式中更輕鬆地分析它們。';
      case 'backup.export.description':
        return '以不同格式下載資料';
      case 'backup.export.dialog_title':
        return '儲存/傳送文件';
      case 'backup.export.success':
        return ({required Object x}) => '檔案已在${x}中成功儲存/下載';
      case 'backup.export.error':
        return '下載檔案時發生錯誤。請透過 lozin.technologies@gmail.com 聯絡開發人員';
      ...
      case 'backup.import.restore_backup_descr':
        return '從 Monekin 匯入先前儲存的資料庫。此操作將用新資料取代任何當前應用程式資料';
      case 'backup.import.restore_backup_warn_description':
        return '導入新資料庫時，您將丟失應用程式中當前保存的所有資料。建議在繼續之前進行備份。請勿在此處上傳任何來源不明的文件，僅上傳您之前從其下載的文件 Monekin';
      ...
      case 'settings.lang_help':
        return '如果您想與此應用程式的翻譯合作，您可以參考<a href=\'https://github.com/enrique-lozano/Monekin/tree/main/lib/i18n\'>我們的指南</a>';
      ...
      case 'settings.amoled_mode_descr':
        return '盡可能使用純黑色壁紙。這對 AMOLED 螢幕設備的電池略有幫助';
      ...
      case 'more.data.delete_all_message1':
        return '您確定要繼續嗎？您的所有資料將永久刪除且無法恢復';
      case 'more.data.delete_all_header2':
        return '最後一步⚠️⚠️';
      case 'more.data.delete_all_message2':
        return '刪除帳戶後，您將刪除所有儲存的個人資料。您的帳戶、交易、預算和類別將被刪除且無法恢復。您同意嗎？';
      case 'more.about_us.display':
        return '應用程式資訊';
      case 'more.about_us.description':
        return '查看有關 Monekin 的條款和其他相關資訊。透過報告錯誤、留下建議與社區取得聯繫......';
      ...
      case 'more.help_us.share_descr':
        return '與朋友和家人分享我們的應用程式';
      case 'more.help_us.share_text':
        return 'Monekin！最好的個人理財應用程式。在這裡下載';
      case 'more.help_us.thanks':
        return '謝謝你！';
      case 'more.help_us.thanks_long':
        return '您對 Monekin 和其他大大小小的開源專案的貢獻使得這樣偉大的專案成為可能。感謝您花時間做出貢獻。';
      case 'more.help_us.donate':
        return '做捐贈';
      case 'more.help_us.donate_descr':
        return '透過您的捐款，您將幫助該應用程式繼續改進。還有什麼比邀請我喝咖啡來感謝所做的工作更好的方式呢？';
      case 'more.help_us.donate_success':
        return '捐款已完成。非常感謝您的貢獻！❤️';
      case 'more.help_us.donate_err':
        return '糟糕！接收您的付款時出現錯誤';
