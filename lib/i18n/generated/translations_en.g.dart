...
class TranslationsCurrenciesEn {
  ...
  late final TranslationsCurrenciesFormEn form = TranslationsCurrenciesFormEn._(
    _root,
  );
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'general.validations.form_error':
        return 'Fix the indicated fields to continue';
      ...
      case 'stats.cash_flow_subtitle':
        return 'Am I spending less than I earn?';
      ...
      case 'transaction.list.empty':
        return 'No transactions found to display here. Add a few transactions in the app and maybe you\'ll have better luck next time.';
      ...
      case 'transaction.form.validators.transfer_between_same_accounts':
        return 'The origin and the destination account cannot be the same';
      ...
      case 'transaction.form.description_info':
        return 'Tap here to enter a more detailed description about this transaction';
      ...
      case 'transaction.reversed.description_for_expenses':
        return 'Despite being an expense transaction, it has a positive amount. These types of transactions can be used to represent the return of a previously recorded expense, such as a refund or having the payment of a debt.';
      case 'transaction.reversed.description_for_incomes':
        return 'Despite being an income transaction, it has a negative amount. These types of transactions can be used to void or correct an income that was incorrectly recorded, to reflect a return or refund of money or to record payment of debts.';
      ...
      case 'transaction.status.none_descr':
        return 'Transaction without a specific state';
      ...
      case 'transfer.form.value_in_destiny.title':
        return 'Amount transferred at destination';
      case 'transfer.form.value_in_destiny.amount_short':
        return ({required Object amount}) => '${amount} to target account';
      ...
      case 'recurrent_transactions.status.delayed_by':
        return ({required Object x}) => 'Delayed by ${x}d';
      case 'recurrent_transactions.status.coming_in':
        return ({required Object x}) => 'In ${x} days';
      ...
      case 'settings.lang_help':
        return 'If you want to collaborate with the translations of this app, you can consult <a href=\'https://github.com/enrique-lozano/Monekin/tree/main/lib/i18n\'>our guide</a>';
