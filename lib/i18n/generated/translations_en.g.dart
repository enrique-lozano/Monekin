...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'intro.skip' => 'Skip',
			'intro.next' => 'Next',
			'intro.select_your_currency' => 'Select your currency',
			'intro.welcome_subtitle' => 'Your personal finance manager',
			'intro.welcome_subtitle2' => '100% open, 100% free',
			'intro.welcome_footer' => 'By logging in you agree to the <a href=\'https://github.com/enrique-lozano/Monekin/blob/main/docs/PRIVACY_POLICY.md\'>Privacy Policy</a> and the <a href=\'https://github.com/enrique-lozano/Monekin/blob/main/docs/TERMS_OF_USE.md\'>Terms of Use</a> of the application',
			'intro.offline_descr_title' => 'OFFLINE ACCOUNT:',
			'intro.offline_descr' => 'Your data will only be stored on your device, and will be safe as long as you don\'t uninstall the app or change phone. To prevent data loss, it is recommended to make a backup regularly from the app settings.',
			'intro.offline_start' => 'Start session offline',
			'intro.sl1_title' => 'Select your currency',
			'intro.sl1_descr' => 'Your default currency will be used in reports and general charts. You will be able to change the currency and the app language later at any time in the application settings',
			'intro.sl2_title' => 'Safe, private and reliable',
			'intro.sl2_descr' => 'Your data is only yours. We store the information directly on your device, without going through external servers. This makes it possible to use the app even without internet',
			'intro.sl2_descr2' => 'Also, the source code of the application is public, anyone can collaborate on it and see how it works',
			'intro.last_slide_title' => 'All ready',
			'intro.last_slide_descr' => 'With Monekin, you can finally achieve the financial independence you want so much. You will have graphs, budgets, tips, statistics and much more about your money.',
			'intro.last_slide_descr2' => 'We hope you enjoy your experience! Do not hesitate to contact us in case of doubts, suggestions...',
