  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'general.validations.form_error':
        return 'Corrije los campos indicados en el formulario para continuar';
      ...
      case 'stats.cash_flow_subtitle':
        return '¿Estoy gastando menos de lo que gano?';
      ...
      case 'transaction.list.empty':
        return 'No se han encontrado transacciones que mostrar aquí. Añade unas cuantas transacciones en la app y quizas tengas más suerte la proxima vez';
      ...
      case 'transaction.form.validators.transfer_between_same_accounts':
        return 'Las cuentas de origen y destino no pueden coincidir';
      ...
      case 'transaction.form.description_info':
        return 'Toca aquí para escribir una descripción mas detallada sobre esta transacción';
      ...
      case 'transaction.reversed.title':
        return 'Transacción invertida';
      case 'transaction.reversed.title_short':
        return 'Tr. invertida';
      case 'transaction.reversed.description_for_expenses':
        return 'A pesar de ser una transacción de tipo gasto, esta transacción tiene un monto positivo. Este tipo de transacciones pueden usarse para representar la devolución de un gasto previamente registrado, como un reembolso o que te realicen el pago de una deuda.';
      case 'transaction.reversed.description_for_incomes':
        return 'A pesar de ser una transacción de tipo ingreso, esta transacción tiene un monto negativo. Este tipo de transacciones pueden usarse para anular o corregir un ingreso que fue registrado incorrectamente, para reflejar una devolución o reembolso de dinero o para registrar el pago de deudas.';
      ...
      case 'transaction.status.none_descr':
        return 'Transacción sin un estado concreto';
      ...
      case 'transfer.form.value_in_destiny.amount_short':
        return ({required Object amount}) => '${amount} a cuenta de destino';
      ...
      case 'recurrent_transactions.status.delayed_by':
        return ({required Object x}) => 'Atrasado por ${x}d';
      case 'recurrent_transactions.status.coming_in':
        return ({required Object x}) => 'En ${x} días';
      ...
      case 'settings.lang_help':
        return 'Si quieres colaborar con las traducciones de esta app puedes consultar <a href=\'https://github.com/enrique-lozano/Monekin/tree/main/lib/i18n\'>nuestra guía</a> ';
