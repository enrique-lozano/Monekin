...
class _TranslationsAccountEn {
  ...
  late final _TranslationsAccountArchiveEn archive =
      _TranslationsAccountArchiveEn._(_root);
...
class _TranslationsCategoriesEn {
  ...
  String merge_warning1(
      ...
      'All transactions (<b>${x}</b>) associated with the category <b>${from}</b> will be moved to the category <b>${destiny}</b>';
...
class _TranslationsSettingsEn {
  ...
  late final _TranslationsSettingsGeneralEn general =
      _TranslationsSettingsGeneralEn._(_root);
  late final _TranslationsSettingsDataEn data =
      _TranslationsSettingsDataEn._(_root);
  late final _TranslationsSettingsAboutUsEn about_us =
      _TranslationsSettingsAboutUsEn._(_root);
  late final _TranslationsSettingsHelpUsEn help_us =
      _TranslationsSettingsHelpUsEn._(_root);
}
...
class _TranslationsFinancialHealthMonthsWithoutIncomeEn {
  ...
  // Translations
  String good({required Object x}) =>
      'Well done! At your current spending rate right now you could survive up to ${x} months without any income';
  String normal({required Object x}) =>
      'At your current spending rate right now you could survive up to ${x} months without any income. While this value is acceptable, you can still improve a little more!';
  String bad({required Object x}) =>
      'Wow! You would barely survive ${x} months without income at your current spending rate. Remember that it is recommended to be able to live at least 6 months without any income';
  String get very_bad =>
      'Wow! You could hardly survive a month without income at your current spending rate. Remember that it is recommended to be able to live at least 6 months without any income';
...
class _TranslationsFinancialHealthSavingsPercentageEn {
  ...
  String good({required Object value}) =>
      'Congratulations! You have managed to save ${value}% of your income during this period. It seems that you are already quite an expert. Keep it up!';
  String normal({required Object value}) =>
      'Congratulations, you managed to save ${value}% of your income during this period. Visit the analysis tab to see where you can save even more!';
  String bad({required Object value}) =>
      'You have managed to save ${value}% of your income during this period. However, we believe that you can still do much more! Remember that it is recommended to save at least 30% of what you earn';
  String get very_bad =>
      'Wow, you haven\'t managed to save anything during this period :( Visit the analysis tab to see where your financial weaknesses are. Remember that it is recommended to save at least 30% of what you earn';
}
...
class _TranslationsTransactionFormEn {
  ...
  String exchange_to_preferred_today({required Object currency}) =>
      'Equivalent to ${currency} today:';
  String exchange_to_preferred_in_date(
          {required Object currency, required Object date}) =>
      'Equivalent to ${currency} on ${date}:';
}
...
class _TranslationsTransferFormEn {
  ...
  String currency_info_add({required Object x}) =>
      '${x} will be transferred to the destination account &#183; Click to edit';
  String currency_info_edit({required Object x}) =>
      '${x} have been transferred to the destination account &#183; Click to edit';
...
class _TranslationsRecurrentTransactionsDetailsEn {
  ...
  String next_payment_info({required Object date}) =>
      'The next movement of this transaction will take place on ${date}. You can choose whether you want to skip this movement or accept it on the date of your choice';
  String last_payment_info({required Object date}) =>
      'The next move for this transaction will take place on ${date}. This payment will be the last for the recurring rule, so this rule will be automatically removed when this payment is made';
...
class _TranslationsAccountArchiveEn {
  ...
  String get warn =>
      'This account will no longer appear in certain listings and you will not be able to create new transactions on this account. You can unarchive this account whenever you want';
  String get should_have_zero_balance =>
      'You must have a current balance of 0 to be able to archive this account. Please edit it before continuing';
...
class _TranslationsBackupExportEn {
  ...
  String get transactions_descr =>
      'Export your transactions in various formats so you can more easily analyze them in other programs or applications.';
  String get description => 'Download your data in different formats';
  String get dialog_title => 'Save/Send file';
  String get success_in_documents =>
      'File successfully saved to Internal Storage/Documents';
...
class _TranslationsBackupImportEn {
  ...
  String get restore_backup_warn =>
...
class _TranslationsSettingsGeneralEn {
  ...
  String get prefer_calc_descr =>
      'Displays a calculator on the add/edit transaction page that will simplify actions on devices without a keyboard';
}
...
class _TranslationsSettingsAboutUsEn {
  ...
  late final _TranslationsSettingsAboutUsLegalEn legal =
      _TranslationsSettingsAboutUsLegalEn._(_root);
  late final _TranslationsSettingsAboutUsProjectEn project =
      _TranslationsSettingsAboutUsProjectEn._(_root);
}
...
class _TranslationsFinancialHealthReviewDescrEn {
  ...
  String get bad =>
      'It seems that your financial situation is not the best yet. Explore the analysis tab to learn more about your finances';
  String get very_bad =>
      'Hmm, your financial health is far below what it should be. Try to see where the problem is in the analysis section';
}
...
class _TranslationsEs implements _TranslationsEn {
  ...
  @override
  late final _TranslationsLangEs lang = _TranslationsLangEs._(_root);
}
...
class _TranslationsGeneralEs implements _TranslationsGeneralEn {
  ...
  String get unspecified => 'Sin especificar';
  @override
  String get attention => 'Atención ⚠️';
  @override
...
class _TranslationsAccountEs implements _TranslationsAccountEn {
  ...
  @override
  late final _TranslationsAccountArchiveEs archive =
      _TranslationsAccountArchiveEs._(_root);
  @override
...
class _TranslationsCategoriesEs implements _TranslationsCategoriesEn {
  ...
  String merge_warning1(
          {required Object x, required Object from, required Object destiny}) =>
      'Todas las transacciones (<b>${x}</b>) asocidadas con la categoría <b>${from}</b> serán movidas a la categoría <b>${destiny}</b>.';
  @override
  String merge_warning2({required Object from}) =>
...
class _TranslationsBudgetsEs implements _TranslationsBudgetsEn {
  ...
  @override
  String get to_expend => 'por gastar';
  @override
...
class _TranslationsSettingsEs implements _TranslationsSettingsEn {
  ...
  @override
  String get display_name => 'Nombre de usuario';
  @override
  String get lang => 'Idioma de la aplicación';
  @override
  String get lang_descr => 'Idioma en el que se mostrarán los textos en la app';
  @override
  String get locale => 'Región';
  @override
  String get locale_descr =>
      'Establece el formato a usar para fechas, números...';
  @override
  String get locale_warn => 'Al cambiar de región la app se refrescará';
  @override
  ...
  @override
  late final _TranslationsSettingsDataEs data =
      _TranslationsSettingsDataEs._(_root);
  @override
  late final _TranslationsSettingsAboutUsEs about_us =
      _TranslationsSettingsAboutUsEs._(_root);
  @override
  late final _TranslationsSettingsHelpUsEs help_us =
      _TranslationsSettingsHelpUsEs._(_root);
}
...
class _TranslationsFinancialHealthReviewEs
  ...
  // Translations
  @override
  String get very_good => 'Muy buena!';
  @override
  String get good => 'Buena';
  @override
  String get normal => 'En la media';
  @override
  String get bad => 'Regular';
  @override
  String get very_bad => 'Muy mala';
  @override
...
class _TranslationsFinancialHealthMonthsWithoutIncomeEs
  ...
  @override
  String good({required Object x}) =>
      'Bien hecho! Con tu ritmo de gastos actual ahora mismo podrías sobrevivir hasta ${x} meses sin ningún ingreso';
  @override
  String normal({required Object x}) =>
      'Con tu ritmo de gastos actual ahora mismo podrías sobrevivir hasta ${x} meses sin ningún ingreso. Si bien este valor es aceptable, aun puedes mejorar un poco más!';
  @override
  String bad({required Object x}) =>
      'Vaya! Apenás sobrevivirías ${x} meses sin ingresos con tu ritmo de gastos actual. Recuerda que lo recomendable es poder vivir al menos 6 meses sin ningun ingreso';
  @override
  String get very_bad =>
      'Vaya! Apenas sobrevivirías un mes sin ingresos con tu ritmo de gastos actual. Recuerda que lo recomendable es poder vivir al menos 6 meses sin ningun ingreso';
  @override
  String get insufficient_data =>
...
class _TranslationsFinancialHealthSavingsPercentageEs
  ...
  @override
  String good({required Object value}) =>
      'Enhorabuena! Has conseguido ahorrar un ${value}% de tus ingresos durante este periodo. Parece que ya eres todo un expert@. Sigue asi!';
  @override
  String normal({required Object value}) =>
      'Enhorabuena, has conseguido ahorrar un ${value}% de tus ingresos durante este periodo. Visita la pestaña de análisis para ver donde puedes ahorrar aun más!';
  @override
  String bad({required Object value}) =>
      'Has conseguido ahorrar un ${value}% de tus ingresos durante este periodo. Sin embargo, creemos que aun puedes hacer mucho mas! Recuerda que es recomendable ahorrar al menos un 30% de lo que ingresas';
  @override
  String get very_bad =>
      'Vaya, no has conseguido ahorrar nada durante este periodo :( Visita la pestaña de análisis para ver donde estan tus debilidades financieras. Recuerda que es recomendable ahorrar al menos un 30% de lo que ingresas';
}
...
class _TranslationsTransactionFormEs implements _TranslationsTransactionFormEn {
  ...
  @override
  String exchange_to_preferred_today({required Object currency}) =>
      'Equivalencia a ${currency} hoy:';
  @override
  String exchange_to_preferred_in_date(
          {required Object currency, required Object date}) =>
      'Equivalencia a ${currency} el ${date}:';
}
...
class _TranslationsRecurrentTransactionsDetailsEs
  ...
  @override
  String next_payment_info({required Object date}) =>
      'El próximo movimiento de esta transacción tendrá lugar el día ${date}. Puedes elegir si deseas saltar este movimiento o aceptarlo en la fecha que elijas';
  @override
  String last_payment_info({required Object date}) =>
      'El próximo movimiento de esta transacción tendrá lugar el día ${date}. Este pago será el último de la regla recurrente, por lo que se eliminará esta regla de forma automática al realizar este pago';
  @override
...
class _TranslationsAccountDeleteEs implements _TranslationsAccountDeleteEn {
  ...
  // Translations
  @override
  String get warning_header => '¿Estas seguro?';
  @override
  String get warning_text =>
      'Esta acción borrara esta cuenta y todas sus transacciones';
  @override
...
class _TranslationsBudgetsDetailsEs implements _TranslationsBudgetsDetailsEn {
  ...
  @override
  String get you_already_expend => 'Gastado';
  @override
  String get expend_diary_left => 'Gasto diario restante recomendado';
  @override
...
class _TranslationsBackupExportEs implements _TranslationsBackupExportEn {
  ...
  @override
  String get title_sort => 'Exportar';
  @override
  ...
  @override
  String get transactions_descr =>
      'Exporta tus transacciones en diversos formatos para que puedas analizarlas mas facilmente en otros programas o aplicaciones.';
  @override
  ...
  @override
  String get success_in_documents =>
      'Archivo guardado correctamente en Almacenamiento interno/Documents';
  @override
  String get success_in_data => 'Archivo guardado/enviado correctamente';
  @override
  String get error =>
...
class _TranslationsBackupImportEs implements _TranslationsBackupImportEn {
  ...
  @override
  String get title_sort => 'Importar';
  @override
...
class _TranslationsSettingsGeneralEs implements _TranslationsSettingsGeneralEn {
  ...
  // Translations
  @override
  String get display => 'Ajustes generales';
  @override
  String get categories_descr => 'Crea y edita categorías a tu gusto';
  @override
  String get other => 'Ajustes avanzados';
  @override
  String get other_descr =>
      'Otros ajustes generales de personalización de la app';
  @override
  String get appearance => 'Apariencia';
  @override
  String get appearance_descr => 'Tema de la aplicación, textos...';
  @override
  ...
  @override
  String get amoled_mode_descr =>
      'Usa un fondo de pantalla negro puro cuando sea posible. Esto ayudará ligeramente a la bateria de dispositivos con pantallas AMOLED';
  @override
  String get dynamic_colors => 'Colores dinámicos';
  @override
  String get dynamic_colors_descr =>
      'Usa el color de acentuación de su sistema siempre que sea posible';
  @override
  String get accent_color => 'Color de acentuación';
  @override
  String get accent_color_descr =>
      'Elige el color que usará la app para enfatizar ciertas partes de la interfaz';
  @override
  String get prefer_calc => 'Preferir calculadora';
  @override
  String get prefer_calc_descr =>
      'Muestra en la página de adición/edición de transacciones una calculadora que simplificará las acciones en dispositivos sin teclado';
}
...
class _TranslationsSettingsAboutUsEs implements _TranslationsSettingsAboutUsEn {
  ...
  @override
  late final _TranslationsSettingsAboutUsLegalEs legal =
      _TranslationsSettingsAboutUsLegalEs._(_root);
  @override
  late final _TranslationsSettingsAboutUsProjectEs project =
      _TranslationsSettingsAboutUsProjectEs._(_root);
}
...
class _TranslationsFinancialHealthReviewDescrEs
  ...
  @override
  String get bad =>
      'Parece que tu situación financiera no es la mejor aun. Explora la pestaña de análisis para conocer mas sobre tus finanzas';
  @override
  String get very_bad =>
      'Mmm, tu salud financera esta muy por debajo de lo que debería. Trata de ver donde esta el problema en la sección de análisis';
}
...
// Path: settings.about_us.legal
class _TranslationsSettingsAboutUsLegalEs
    implements _TranslationsSettingsAboutUsLegalEn {
...
// Path: settings.about_us.project
class _TranslationsSettingsAboutUsProjectEs
    implements _TranslationsSettingsAboutUsProjectEn {
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'financial_health.review.descr.bad':
        return 'It seems that your financial situation is not the best yet. Explore the analysis tab to learn more about your finances';
      case 'financial_health.review.descr.very_bad':
        return 'Hmm, your financial health is far below what it should be. Try to see where the problem is in the analysis section';
      case 'financial_health.months_without_income.good':
        return ({required Object x}) =>
            'Well done! At your current spending rate right now you could survive up to ${x} months without any income';
      case 'financial_health.months_without_income.normal':
        return ({required Object x}) =>
            'At your current spending rate right now you could survive up to ${x} months without any income. While this value is acceptable, you can still improve a little more!';
      case 'financial_health.months_without_income.bad':
        return ({required Object x}) =>
            'Wow! You would barely survive ${x} months without income at your current spending rate. Remember that it is recommended to be able to live at least 6 months without any income';
      case 'financial_health.months_without_income.very_bad':
        return 'Wow! You could hardly survive a month without income at your current spending rate. Remember that it is recommended to be able to live at least 6 months without any income';
      ...
      case 'financial_health.savings_percentage.good':
        return ({required Object value}) =>
            'Congratulations! You have managed to save ${value}% of your income during this period. It seems that you are already quite an expert. Keep it up!';
      case 'financial_health.savings_percentage.normal':
        return ({required Object value}) =>
            'Congratulations, you managed to save ${value}% of your income during this period. Visit the analysis tab to see where you can save even more!';
      case 'financial_health.savings_percentage.bad':
        return ({required Object value}) =>
            'You have managed to save ${value}% of your income during this period. However, we believe that you can still do much more! Remember that it is recommended to save at least 30% of what you earn';
      case 'financial_health.savings_percentage.very_bad':
        return 'Wow, you haven\'t managed to save anything during this period :( Visit the analysis tab to see where your financial weaknesses are. Remember that it is recommended to save at least 30% of what you earn';
      case 'stats.title':
        return 'Statistics';
      case 'stats.balance':
        return 'Balance';
      ...
      case 'transaction.form.exchange_to_preferred_today':
        return ({required Object currency}) =>
            'Equivalent to ${currency} today:';
      case 'transaction.form.exchange_to_preferred_in_date':
        return ({required Object currency, required Object date}) =>
            'Equivalent to ${currency} on ${date}:';
      ...
      case 'recurrent_transactions.details.next_payment_info':
        return ({required Object date}) =>
            'The next movement of this transaction will take place on ${date}. You can choose whether you want to skip this movement or accept it on the date of your choice';
      ...
      case 'account.archive.title':
        return 'Archive account';
      case 'account.archive.warn':
        return 'This account will no longer appear in certain listings and you will not be able to create new transactions on this account. You can unarchive this account whenever you want';
      case 'account.archive.should_have_zero_balance':
        return 'You must have a current balance of 0 to be able to archive this account. Please edit it before continuing';
      case 'account.archive.success':
        return 'Account archived successfully';
      case 'account.archive.unarchive_succes':
        return 'Account unarchived successfully';
      ...
      case 'budgets.details.statistics':
        return 'Statistics';
      case 'budgets.details.you_already_expend':
        return 'Spent';
      case 'budgets.details.expend_diary_left':
        return 'Remaining recommended daily spend';
      ...
      case 'backup.export.transactions_descr':
        return 'Export your transactions in various formats so you can more easily analyze them in other programs or applications.';
      ...
      case 'backup.export.success_in_documents':
        return 'File successfully saved to Internal Storage/Documents';
      case 'backup.export.success_in_data':
        return 'File saved/downloaded successfully';
      ...
      case 'backup.import.title_sort':
        return 'Import';
      case 'backup.import.restore_backup':
        return 'Restore Backup';
      case 'backup.import.restore_backup_warn':
      ...
      case 'settings.general.categories_descr':
        return 'Create and edit categories to your liking';
      case 'settings.general.other':
        return 'Advanced settings';
      case 'settings.general.other_descr':
        return 'Other general app customization settings';
      case 'settings.general.appearance':
        return 'Appearance';
      case 'settings.general.appearance_descr':
        return 'App theme, texts...';
      case 'settings.general.theme':
        return 'Theme';
      case 'settings.general.theme_auto':
        return 'Defined by the system';
      case 'settings.general.theme_light':
        return 'Light';
      case 'settings.general.theme_dark':
        return 'Dark';
      case 'settings.general.amoled_mode':
        return 'AMOLED mode';
      case 'settings.general.amoled_mode_descr':
        return 'Use a pure black wallpaper when possible. This will slightly help the battery of devices with AMOLED screens';
      case 'settings.general.dynamic_colors':
        return 'Dynamic colors';
      case 'settings.general.dynamic_colors_descr':
        return 'Use your system accent color whenever possible';
      case 'settings.general.accent_color':
        return 'Accent color';
      case 'settings.general.accent_color_descr':
        return 'Choose the color the app will use to emphasize certain parts of the interface';
      case 'settings.general.prefer_calc':
        return 'Prefer calculator';
      case 'settings.general.prefer_calc_descr':
        return 'Displays a calculator on the add/edit transaction page that will simplify actions on devices without a keyboard';
      case 'settings.data.display':
        return 'Data';
      case 'settings.data.display_descr':
        return 'Export and import your data so you don\'t lose anything';
      case 'settings.data.delete_all':
        return 'Delete my data';
      case 'settings.data.delete_all_header1':
        return 'Stop right there padawan ⚠️⚠️';
      case 'settings.data.delete_all_message1':
        return 'Are you sure you want to continue? All your data will be permanently deleted and cannot be recovered';
      case 'settings.data.delete_all_header2':
        return 'One last step ⚠️⚠️';
      case 'settings.data.delete_all_message2':
      ...
      case 'settings.about_us.display':
        return 'App information';
      case 'settings.about_us.description':
      ...
      case 'settings.about_us.legal.display':
        return 'Legal information';
      case 'settings.about_us.legal.privacy':
        return 'Privacy policy';
      case 'settings.about_us.legal.terms':
        return 'Terms of use';
      case 'settings.about_us.legal.licenses':
        return 'Licenses';
      case 'settings.about_us.project.display':
        return 'Project';
      case 'settings.about_us.project.contributors':
        return 'Collaborators';
      case 'settings.about_us.project.contributors_descr':
        return 'All the developers who have made Monekin grow';
      case 'settings.about_us.project.contact':
        return 'Contact us';
      case 'settings.help_us.display':
        return 'Help us';
      case 'settings.help_us.description':
        return 'Find out how you can help Monekin become better and better';
      case 'settings.help_us.rate_us':
        return 'Rate us';
      case 'settings.help_us.rate_us_descr':
        return 'Any rate is welcome!';
      case 'settings.help_us.share':
        return 'Share Monekin';
      case 'settings.help_us.share_descr':
        return 'Share our app to friends and family';
      case 'settings.help_us.share_text':
        return 'Monekin! The best personal finance app. Download it here';
      case 'settings.help_us.thanks':
        return 'Thank you!';
      case 'settings.help_us.thanks_long':
      ...
      case 'settings.help_us.donate':
        return 'Make a donation';
      case 'settings.help_us.donate_descr':
...
extension on _TranslationsEs {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'financial_health.review.descr.bad':
        return 'Parece que tu situación financiera no es la mejor aun. Explora la pestaña de análisis para conocer mas sobre tus finanzas';
      case 'financial_health.review.descr.very_bad':
        return 'Mmm, tu salud financera esta muy por debajo de lo que debería. Trata de ver donde esta el problema en la sección de análisis';
      case 'financial_health.months_without_income.good':
        return ({required Object x}) =>
            'Bien hecho! Con tu ritmo de gastos actual ahora mismo podrías sobrevivir hasta ${x} meses sin ningún ingreso';
      case 'financial_health.months_without_income.normal':
      ...
      case 'financial_health.months_without_income.bad':
        return ({required Object x}) =>
            'Vaya! Apenás sobrevivirías ${x} meses sin ingresos con tu ritmo de gastos actual. Recuerda que lo recomendable es poder vivir al menos 6 meses sin ningun ingreso';
      case 'financial_health.months_without_income.very_bad':
        return 'Vaya! Apenas sobrevivirías un mes sin ingresos con tu ritmo de gastos actual. Recuerda que lo recomendable es poder vivir al menos 6 meses sin ningun ingreso';
      case 'financial_health.months_without_income.insufficient_data':
      ...
      case 'financial_health.savings_percentage.bad':
        return ({required Object value}) =>
            'Has conseguido ahorrar un ${value}% de tus ingresos durante este periodo. Sin embargo, creemos que aun puedes hacer mucho mas! Recuerda que es recomendable ahorrar al menos un 30% de lo que ingresas';
      case 'financial_health.savings_percentage.very_bad':
        return 'Vaya, no has conseguido ahorrar nada durante este periodo :( Visita la pestaña de análisis para ver donde estan tus debilidades financieras. Recuerda que es recomendable ahorrar al menos un 30% de lo que ingresas';
      case 'stats.title':
        return 'Estadísticas';
      case 'stats.balance':
        return 'Saldo';
      ...
      case 'account.delete.warning_header':
        return '¿Estas seguro?';
      case 'account.delete.warning_text':
        return 'Esta acción borrara esta cuenta y todas sus transacciones';
      case 'account.delete.success':
      ...
      case 'budgets.details.you_already_expend':
        return 'Gastado';
      case 'budgets.details.expend_diary_left':
        return 'Gasto diario restante recomendado';
      case 'budgets.details.expend_evolution':
      ...
      case 'backup.export.transactions_descr':
        return 'Exporta tus transacciones en diversos formatos para que puedas analizarlas mas facilmente en otros programas o aplicaciones.';
      case 'backup.export.description':
        return 'Exporta tus datos en diferentes formatos';
      case 'backup.export.dialog_title':
        return 'Guardar/Enviar archivo';
      case 'backup.export.success_in_documents':
        return 'Archivo guardado correctamente en Almacenamiento interno/Documents';
      case 'backup.export.success_in_data':
        return 'Archivo guardado/enviado correctamente';
      case 'backup.export.error':
      ...
      case 'settings.lang_descr':
        return 'Idioma en el que se mostrarán los textos en la app';
      case 'settings.locale':
        return 'Región';
      case 'settings.locale_descr':
        return 'Establece el formato a usar para fechas, números...';
      case 'settings.locale_warn':
        return 'Al cambiar de región la app se refrescará';
      case 'settings.first_day_of_week':
        return 'Primer día de la semana';
      case 'settings.general.display':
        return 'Ajustes generales';
      case 'settings.general.categories_descr':
        return 'Crea y edita categorías a tu gusto';
      case 'settings.general.other':
        return 'Ajustes avanzados';
      case 'settings.general.other_descr':
        return 'Otros ajustes generales de personalización de la app';
      case 'settings.general.appearance':
        return 'Apariencia';
      case 'settings.general.appearance_descr':
        return 'Tema de la aplicación, textos...';
      case 'settings.general.theme':
        return 'Tema';
      case 'settings.general.theme_auto':
      ...
      case 'settings.general.amoled_mode':
        return 'Modo AMOLED';
      case 'settings.general.amoled_mode_descr':
        return 'Usa un fondo de pantalla negro puro cuando sea posible. Esto ayudará ligeramente a la bateria de dispositivos con pantallas AMOLED';
      case 'settings.general.dynamic_colors':
        return 'Colores dinámicos';
      case 'settings.general.dynamic_colors_descr':
        return 'Usa el color de acentuación de su sistema siempre que sea posible';
      case 'settings.general.accent_color':
        return 'Color de acentuación';
      case 'settings.general.accent_color_descr':
        return 'Elige el color que usará la app para enfatizar ciertas partes de la interfaz';
      case 'settings.general.prefer_calc':
        return 'Preferir calculadora';
      case 'settings.general.prefer_calc_descr':
        return 'Muestra en la página de adición/edición de transacciones una calculadora que simplificará las acciones en dispositivos sin teclado';
      case 'settings.data.display':
        return 'Datos';
      case 'settings.data.display_descr':
