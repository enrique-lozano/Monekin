...
/// Transfer: two bordered cards (source / destination) with amounts,
/// optional FX between them, and insufficient-balance warning.
...
class _DualLegBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final fxFromCode = effectiveFrom?.currency.code;
    final fxToCode = effectiveTo?.currency.code;
    ...
    Widget buildLegs({
      ...
      final bottomCurrency = to?.currency;
            ...
            child: _DualLegCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (to != null) const SizedBox(height: 10),
                  _LegAmountRow(
                    show: to != null,
                    isOutflow: !topOut,
                    ...
                    showReset: topOut ? destMismatch : sourceMismatch,
                    onReset: topOut
                        ? c.clearTransferDestinationOverride
                        : () => c.alignTransferSourceFromInverseConverted(
                            expectedSource,
